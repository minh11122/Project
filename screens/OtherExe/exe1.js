    ...
    <ScrollView style={styles(colors).container}>
      <View style={styles(colors).headerContainer}>
        ...
        <View style={styles(colors).headerContent}>
          ...
          <Text style={styles(colors).headerTitle}>{t('full_body_challenge')}</Text>
      ...
      <View style={styles(colors).contentContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('StartWorkout')} // Navigate to StartWorkoutScreen
        >
...
const styles = (colors) => StyleSheet.create({
  ...
  tipImage: {
    ...
    height: 40,
    borderRadius: 20,
    marginRight: 10, // Fixed typo: marginRight was set to 1
  },
  tipText: {
    fontSize: 14,
    fontWeight: '600',
